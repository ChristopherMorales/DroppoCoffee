...
<?php require_once ("php/header.php"); ?>
    ...
    <section class="ftco-section">
    		...
    		<li><a href="view_category.php?id=Crema" class="active">Crema </a></li>
              <li><a href="view_category.php?id=Lareño" class="active">Lareño </a></li>
...
<?php 
							...
							<div class='col-md-4 col-sm-6 col-xs-6'>
										<div class='product product-single'>
											...
											<div class='product-body'>
												...
												<h2 class='product-name'><a href='shop.php?item_id=$item_id'>$item_name, $item_weight </a></h2>
												<div class='product-btns'>
													<form action='shop.php?item_id=$item_id' method='post'>
            ...
            echo "
							<div class='col-md-4 col-sm-6 col-xs-6'>
										<div class='product product-single'>
											...
											<div class='product-body'>
												<h3 class='product-price'>Price: $$item_price</h3>
												<h2 class='product-name'><a href='product-single.php?item_id=$item_id'>$item_name, $item_weight</a></h2>
												<div class='product-btns'>
    ...
    {
        //Para no aceptar resultados blancos en el search
        ...
        echo " Search Result: $search";
                ...
                $sql = "SELECT product_id, brand_name, description, weight_oz, grain_type, sale_price, quantity_stock, available, image_url  FROM product p, brand b, weight w, grain g
                    ...
                    brand_name LIKE '%$search%' OR description LIKE '%$search%' AND image_url IS NOT NULL";
                                ...
                                echo "
                                        <div class='col-md-4 col-sm-6 col-xs-6'>
                                                    <div class='product product-single'>
                                                        ...
                                                        <div class='product-body'>
                                                            <h3 class='product-price'>Price: $$item_price</h3>
                                                            <h2 class='product-name'><a href='shop.php?item_id=$item_id'>$item_name, $item_weight oz</a></h2>
                                                            <div class='product-btns'>
