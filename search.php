...
<?php require_once ("php/header.php"); ?>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="indexTest.html">Home</a></span> <span>Products</span></p>
    ...
    <section class="ftco-section">
    		...
    		<li><a href="view_category.php?id=Crema">Crema </a></li>
              <li><a href="view_category.php?id=Lareño">Lareño </a></li>
              <li><a href="view_category.php?id=Oro">Oro </a></li>
              <li><a href="view_category.php? id=Yaucono">Yaucono </a></li>
    			</div>
    		</div>
