...
<?php
                ...
                if(!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
                    ...
                    foreach ($_SESSION["cart_array"] as $each_item) 
                    {
                        ...
                        while($row_item=mysqli_fetch_array($run_item)){
                            ...
                            $item_weight = $row_item['weight_oz'];
                    ...
                    <div class='media'>
                        ...
                        <div class='media-body'>
                            <h4 class='media-heading'><a href='product-single.php?item_id=$item_id'>$item_name, $item_weight oz</a></h4>
             ...
             <tr>
                                        ...
                                        <a style="text-decoration:none;color:white;" href="shop.php">
                                            Continue Shopping </a>
                                        </button></td>
                                        <td>
