...
<!--Nav-->
    ...
    <section class="ftco-section">
        ...
        <?php
          ...
          //Query Top 6 Most Selled
           $top6_query = "SELECT product_id, brand_name, description, weight_oz, grain_type, sale_price, quantity_stock, available, image_url, quantity_sold   
           ...
           ORDER BY quantity_sold DESC LIMIT 6";


                                            
            if($r = mysqli_query($con, $top6_query))//Save & Validate Query Result
            {
