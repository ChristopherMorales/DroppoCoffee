...
<?php
    if(isset($_POST['update']))
    {
        ...
        if(count($errors) == 0)
        {
            ...
            $query = "UPDATE administrator SET name='$name', lastname='$lastname', email='$email', password='$password'
            WHERE admi_id='$admi_id'";
            
            if(mysqli_query($dbc, $query))//Validate
            {
                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            <li class="list-inline-item active">
                                                <a href="product_handling.php">Administrator</a>
                                            </li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">UPDATE Administrator</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>UPDATE</strong> Administrator
                                    </div>
                                    <form action="update_admi.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <?php
                                            //Query Search Administrator
                                            $query = "SELECT *
                                                        FROM administrator
                                                        WHERE admi_id = {$_GET['admi_id']}";
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <?php
                                                print"<input type ='hidden' name='admi_id' value='".$_GET['admi_id']."'>"
                                            ?>
                                        </div>
                                    </form>
                                </div>
