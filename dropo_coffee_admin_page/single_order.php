                                        ...
                                        <table class="table">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class='table-data__info'>
                                                            <h4>COST: $<?php echo $row3['costs'] ?></h4>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </thead>
                                                        ...
                                                        while($row2 = mysqli_fetch_array($r2))//Present Users
                                                        {
                                                            print "
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href='single_product.php?product_id={$row2['product_id']}' class='btn btn-secondary btn-sm'><i class='fa fa-list-ul'></i>&nbsp;Details<a>
                                                                    </td>
                                                                </tr>";
                                                        }
                                                    }
