                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">View Order History</h3>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query_orders = "SELECT order_id, track_number, status_name, order_date
                                                                    ...
                                                                    WHERE o.status_id = s.status_id AND refund = 0
                                                        ...
                                                        if($r_orders2 = mysqli_query($dbc, $query_orders2))
                                                        {
                                                            ...
                                                            print "
                                                                <tr class='tr-shadow'>
                                                                    ...
                                                                    <td>
                                                                        <a href='update_order.php?order_id={$row_orders['order_id']}' class='btn btn-primary btn-sm'><i class='fa fa-pencil-square-o'></i>&nbsp;Edit<a>
                                                                    </td>
                                                                    <td>
                                                                        <a href='single_order.php?order_id={$row_orders['order_id']}' class='btn btn-secondary btn-sm'><i class='fa fa-list-ul'></i>&nbsp;Details<a>
                                                                    </td>
                                                                </tr>";
                                                        }
                                                    }
